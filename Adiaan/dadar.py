...
st.markdown("""
    ...
    /* Hover Effect - yeroo itti mouse geessitu */
    ...
    /* Kaardiiwwan (Dashboard metric cards) */
    .card { 
...
    pdf.set_x(120); pdf.cell(70, 10, "Mallattoo: _____", ln=1, align='R')
    
    return pdf.output(dest='S').encode('latin-1')
...
    pdf.set_x(180); pdf.cell(80, 10, "Mallattoo: _______", ln=1, align='R')
    
    return pdf.output(dest='S').encode('latin-1')
