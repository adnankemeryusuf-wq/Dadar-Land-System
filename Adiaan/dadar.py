...
# Page config jalqaba irratti dhufuu qaba
st.set_page_config(
...
# --- KANNA DHOKSUUF: MANAGE APP, SHARE, DEPLOY FI HALLUU ---
st.markdown("""
    <style>
    /* 1. Menu gubbaa guutummaatti dhoksuuf (Manage App, Share, etc.) */
    ...
    /* 3. Halluu fi Bareedina Sidebar/Buttons */
...
def create_advanced_pdf(name, count, rank, logo_left=None, logo_right=None):
    ...
    if rank == 1:
        rank_color, rank_text = (255, 215, 0), "1FFAA"
    elif rank == 2:
        rank_color, rank_text = (192, 192, 192), "2FFAA"
    else:
        rank_color, rank_text = (205, 127, 50), "3FFAA"
    ...
    pdf.set_y(110); pdf.set_text_color(*deep_green); pdf.set_font('Arial', 'B', 30) 
...
if not st.session_state.logged_in:
    ...
    with col_mid:
        ...
        st.markdown("<h2 style='text-align:center;'>Dadar Land Administration System</h2>", unsafe_allow_html=True)
    ...
    if menu == "📊 Dashboard":
        ...
        # ... (Kutaaleen Registration akkuma duraanitti itti fufu) ...
        ...
        st.header("🔍 Barbaadi")
        # Logic kee isa duraa asitti itti fufa...
