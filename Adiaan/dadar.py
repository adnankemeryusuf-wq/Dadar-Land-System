...
def load_data():
    ...
    # Convert payment to numeric for calculation
...
if not st.session_state.logged_in:
    ...
    with st.sidebar:
        ...
        menu = st.radio("FILANNOO", ["📊 Dashboard", "📝 Galmee Haaraa", "📈 Gabaasa Bal'aa", "🔍 Barbaadi/Edit"])
    ...
    if menu == "📊 Dashboard":
        ...
        if not df.empty:
            ...
            c2.metric("👥 Tajaajilamtoota", f"{len(df)}")
    ...
    # (Add other menu logic here: Galmee Haaraa, Gabaasa, Search)
